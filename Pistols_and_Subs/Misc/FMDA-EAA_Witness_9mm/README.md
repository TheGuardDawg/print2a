...
#### Description 
This is a 3D Printable EAA Witness Frame for 9mm parts kits.

#### Tools and Parts List
Below is a list of tools, parts and materials you should need to complete this project.

##### Off the shelf Glock parts:
* Complete EAA Witness upper (from EveryGunPart, Gunbroker, etc)
* Complete EAA Witness lower parts kit (from EveryGunPart, Gunbroker, etc)
